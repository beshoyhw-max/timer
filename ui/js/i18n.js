...
window.I18N = (function () {
    const TRANSLATIONS = {
        en: {
            ...
            'label.subtractTime': 'Subtract Time (minutes)',
            'btn.addCustom': '+Custom',
            'btn.subCustom': '−Custom',
            'btn.start': '▶ START',
            'btn.pause': '⏸ PAUSE',
            'btn.resume': '▶ RESUME',
            'btn.stop': '■ STOP',
            ...
            'btn.unlink': '🔓 Unlink',
            'btn.restart': '⟲ Restart',
            'btn.generateTemplate': '📋 Generate Template',
            ...
            // Animation Messages
            'label.animMessages': 'Animation Messages',
            'label.textOnTime': '✅ On Time',
            'label.textOvertime': '⏰ Overtime',
            ...
            // Live Mode
            'btn.liveMode': 'Live',
            'title.liveMode': 'Switch to Live Mode',
            'title.addTime': 'Add Time',
            'title.subTime': 'Subtract Time',
            'title.toggleAlarms': 'Toggle Alarms',
            'title.exitLiveMode': 'Exit Live Mode',
            'btn.lmPrev': '⏮ Prev',
            'btn.lmStart': '▶ Start',
            'btn.lmResume': '▶ Resume',
            'btn.lmPause': '⏸ Pause',
            ...
            'title.showMore': 'Show more',
            'title.showLess': 'Show less',
            'lm.add1m': '+1 min',
            'lm.add5m': '+5 min',
            'lm.add10m': '+10 min',
            'lm.add20m': '+20 min',
            ...
            'lm.sub10m': '−10 min',
            'lm.sub20m': '−20 min',
            'lm.noTopics': 'No topics in queue',
        ...
        zh: {
            ...
            // Animation Messages
            'label.animMessages': '动画文字',
            'label.textOnTime': '✅ 准时完成',
            'label.textOvertime': '⏰ 超时',
            ...
            // Live Mode
            'btn.liveMode': '操作模式',
            'title.liveMode': '切换到操作模式',
            'title.addTime': '加时',
            'title.subTime': '减时',
            'title.toggleAlarms': '切换闹钟',
            'title.exitLiveMode': '退出操作模式',
            'btn.lmPrev': '⏮ 上一个',
            'btn.lmStart': '▶ 开始',
            'btn.lmResume': '▶ 继续',
            'btn.lmPause': '⏸ 暂停',
