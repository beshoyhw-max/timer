...
(function () {
    ...
    async function doAutoSave() {
        ...
        const alarm2 = (parseFloat(inputAlarm2.value) || 0) * 60;
        const alarm3Interval = (parseFloat(inputAlarm3.value) || 1) * 60;
        const alarmsEnabled = inputAlarmEnabled.checked;

        try {
            await pywebview.api.save_config(tiers, maxCost, alarm1, alarm2, alarmsEnabled, alarm3Interval);
    ...
    // Validation: alarm2 must be strictly less than alarm1 — live on every keystroke
